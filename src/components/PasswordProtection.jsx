      ...
      <>
        ...
        <div className="min-h-screen bg-cream-200 flex items-center justify-center px-4 py-8 overflow-hidden">
          <style>{`
            ...
            /* Names - Elegant slide + fade from top with slight bounce */
            ...
            /* Input - Scale up with glow effect */
            @keyframes scaleInGlow {
              ...
              50% {
                ...
                box-shadow: 0 0 30px 10px rgba(103, 132, 103, 0.3);
              }
              100% {
                opacity: 1;
                transform: scale(1);
            ...
            input:focus {
              ...
              box-shadow: 0 0 20px rgba(103, 132, 103, 0.3);
              transition: all 0.3s ease;
            }

            button:hover {
              transform: scale(1.03);
              box-shadow: 0 8px 24px rgba(103, 132, 103, 0.4);
              transition: all 0.3s ease;
            }
          ...
          <div className="max-w-md w-full text-center relative z-10">
            ...
            {/* Footer - Gentle fade from bottom */}
            <p className={`text-sm text-gray-500 fade-footer ${isVisible ? 'visible' : ''}`}>
              {t.password.footer}
            </p>
          </div>
        </div>
