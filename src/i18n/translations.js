export const translations = {
  en: {
    ...
    password: {
      ...
      subtitle: "This is a private wedding website",
      label: "Enter Password from Your Invitation",
      placeholder: "Password",
      button: "Enter",
      error: "Incorrect password. Please check your invitation.",
      footer: "Password is case-insensitive and can be found on your invitation",
      languageModal: {
        title: "Choose Your Language",
        subtitle: "Would you like to view this website in Romanian?",
        english: "Continue in English",
        romanian: "Switch to Romanian"
      }
    },
    ...
    nav: {
      ...
      footer: {
        text: "Join us for",
        celebration: "A Weekend Celebration",
    ...
    landing: {
      ...
      timeline: {
        ...
        friday: {
          ...
          dresscode: "Casual",
          afternoon: "Afternoon",
          afternoonEvent: "Arrival & Check-in",
          evening: "Evening",
          eveningEvent: "Welcome Evening & Garden Barbecue"
        },
        saturday: {
      ...
      dresscode: {
        ...
        casual: {
          ...
          text: "Comfortable attire for garden activities and relaxed meals. Think smart casual with a touch of elegance—perfect for enjoying the estate's natural beauty."
        },
        formal: {
          title: "Saturday (Wedding Day) — Black Tie Optional / Formal Attire",
          text: "Floor-length gowns or elegant cocktail dresses. Tuxedos or dark suits. Think sophisticated garden celebration in a historic Transylvanian estate.",
  ...
  ro: {
    ...
    password: {
      names: "Andreea & Marcus",
      subtitle: "Acesta este un site privat de nuntă",
      label: "Introduceți Parola din Invitație",
      placeholder: "Parolă",
      button: "Intră",
      error: "Parolă incorectă. Verificați invitația dumneavoastră.",
      footer: "Parola nu este sensibilă la majuscule și se găsește pe invitație",
      languageModal: {
        title: "Alegeți Limba",
        subtitle: "Doriți să vizualizați acest site în limba română?",
        english: "Continuă în Engleză",
        romanian: "Comută la Română"
      }
    },
    ...
    nav: {
      ...
      wedding: "Detalii Nuntă",
      admin: "Panou Admin",
      footer: {
        text: "Alătură-te nouă pentru",
        celebration: "O Sărbătoare de Weekend",
    ...
    landing: {
      ...
      transportation: {
        ...
        groupText: "Vom asigura un autocar de la București la Conacul Zabola cu plecare la",
      ...
      timeline: {
        ...
        friday: {
          ...
          afternoonEvent: "Sosire & Check-in",
          evening: "Seară",
          eveningEvent: "Seară de Bun Venit & Grătar în Grădină"
        },
        saturday: {
      ...
      dresscode: {
        ...
        casual: {
          ...
          text: "Ținută confortabilă pentru activități în grădină și mese relaxate. Gândește-te la smart casual cu o notă de eleganță—perfect pentru a te bucura de frumusețea naturală a conacului."
        },
        formal: {
          title: "Sâmbătă (Ziua Nunții) — Black Tie Opțional / Ținută Formală",
          text: "Rochii lungi până la podea sau rochii cocktail elegante. Smoking sau costume închise la culoare. Gândește-te la o sărbătoare sofisticată în grădină într-un conac istoric din Transilvania.",
    ...
    admin: {
      ...
      loginPlaceholder: "Introduceți parola",
      loginButton: "Autentificare",
      loginError: "Parolă incorectă",
      dashboardTitle: "Panou de Control Admin",
      stats: {
        submissions: "Total Confirmări",
        totalGuests: "Total Invitați",
        attending: "Participă",
        notAttending: "Nu Participă"
      },
      meals: {
